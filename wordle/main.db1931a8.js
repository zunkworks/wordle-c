    ...
    var Qa = "IN_PROGRESS",
        ...
        ss = function(e) {
            ...
            function t() {
                ...
                e.today = new Date;
                e.today = randomDate(new Date(2021, 5, 19, 0, 0, 0, 0), new Date(2029, 5, 19, 0, 0, 0, 0), 0, 23) 
                console.log(e.today);
                console.log(new Date(e.lastPlayedTs));
                console.log($a(new Date(e.lastPlayedTs), e.today));
                var o = za();
                return e.lastPlayedTs = o.lastPlayedTs, 
                !e.lastPlayedTs || $a(new Date(e.lastPlayedTs), e.today) >= 0 ? (e.boardState = new Array(6).fill(""), 
                    ...
                    if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                        ...
                        if (this.hardMode) {
                            var t = function(e, a, s) {
                                ...
                                r = t.errorMessage;
                            if (!o)
                                return a.setAttribute("invalid", ""), void this.addToast(r || "Not valid in hard mode")
                        }
                        var n = function(e, a) {
                            for (var s = Array(a.length).fill(Ca), t = Array(a.length).fill(!0), o = Array(a.length).fill(!0), r = 0; r < e.length; r++)
                                e[r] === a[r] && o[r] && (s[r] = Ia, t[r] = !1, o[r] = !1);
